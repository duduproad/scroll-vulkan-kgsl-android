# DISCLAIMER
[Scroll](https://github.com/dawsers/scroll) is made by [dawsers](https://github.com/dawsers). I just made a wlroots patch based on [Azkali's wlroots patch](https://github.com/Azkali/phosh-termux-gpu).

## Dependencies

Termux (no root/root) or Droidspaces (root),

If you don't have root, proot-distro on termux.
...
```
git clone https://github.com/duduproad/scroll-vulkan-kgsl.git
```

### Enter the cloned directory and run the script:
```
cd scroll-vulkan-kgsl
chmod +x build-scroll.sh
./build-scroll.sh
```

### Install lfdevs' mesa driver:
[https://github.com/lfdevs/mesa-for-android-container](https://github.com/lfdevs/mesa-for-android-container)
